...
namespace RollingLEAPOptionsSimulator.Utility
{
    using System;
    ...
    internal static class Settings
    {
        ...
        {
            Registry.CurrentUser.CreateSubKey("Software\\PchenaSoft\\TD Ameritrade Client Library for .NET").SetValue(name, value, RegistryValueKind.DWord);
        }

        internal static void Set<T>(string name, T value)
        {
            Registry.CurrentUser.CreateSubKey("Software\\PchenaSoft\\TD Ameritrade Client Library for .NET").SetValue(name, value);
        }
